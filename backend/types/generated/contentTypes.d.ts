...
export interface ApiBlogVersionBlogVersion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    blogCreatedAt: Schema.Attribute.DateTime;
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blog_versions: Schema.Attribute.Relation<
      'oneToMany',
      'api::blog-version.blog-version'
    >;
    blogCreatedAt: Schema.Attribute.DateTime;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Guest'>;
    blog: Schema.Attribute.Relation<'manyToOne', 'api::blog.blog'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::blog-version.blog-version': ApiBlogVersionBlogVersion;
